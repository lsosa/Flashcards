...
public class Database extends Activity{
    ...
    private static final String TAG_USERS_ID = "users_id";
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		user_id = i.getStringExtra(TAG_USERS_ID);
     ...
     * */
    class LoadAllUserData extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(Database.this);
        ...
        protected ArrayList<HashMap<String, String>> getAllLectures(JSONObject jsonLectures){
        	...
        	try {
                ...
                if (success == 1) {
                    ...
                    // no lectures found
                	Toast.makeText(getApplicationContext(), "Not lectures found!", Toast.LENGTH_LONG).show();
        ...
        protected ArrayList<HashMap<String, String>> getAllNotes(JSONObject jsonNotes){
        	...
        	try {
                ...
                if (success == 1) {
                    ...
                    // no notes found
                	Toast.makeText(getApplicationContext(), "Not notes found!", Toast.LENGTH_LONG).show();
        ...
        protected void onPostExecute(String file_url) {
			...
			i.putExtra("courses", coursesList);
			i.putExtra("lectures", lecturesList);
			i.putExtra("notes", notesList);
			startActivity(i);
			finish();
        }
